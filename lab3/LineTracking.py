...
def detectLine(frame):
    ...
    Returns:
        lineCenter: A number between [-1, 1] denoting where the center of the line
                    is relative to the frame.
        newFrame: Processed frame with the detected line marked using
                  cv2.rectangle() and center marked using cv2.circle().
    """
    # TODO: Implement line detection logic here
    lineCenter = 0.0
    newFrame = frame.copy()
